...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../chinon100.sopcinfo
...
# Design Name 
# setting SOPC_NAME is chinon100
SOPC_NAME := chinon100
...
# setting SOPC_SYSID_BASE_ADDRESS is 0xd000
SOPC_SYSID_FLAG += --sidp=0xd000
ELF_PATCH_FLAG  += --sidp 0xd000

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1527295768
SOPC_SYSID_FLAG += --timestamp=1527295768
ELF_PATCH_FLAG  += --timestamp 1527295768
